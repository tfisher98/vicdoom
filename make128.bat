cl65 -I d:\retro\cc65-2.13\include -I src -I src\textures -I . --lib-path d:\retro\cc65-2.13\lib -t c128 -C doom_c128_cc65.cfg -Ln doom128.lbl -O src\vicdoom.c src\menu.c src\automap.c src\p_enemy.c src\summary.c src\victory.c src\util.c src\cheatsAsm.s src\utilAsm_c128.s src\enemy.s src\m_random.s src\doomlogo.s src\drawLine.s src\updateInput.s src\doomfont.s src\textures\textures.s src\dpsounds.s src\playSound_c128.s src\drawColumnAsm.s src\logMathAsm.s src\mapAsm.s -vm -m map.txt -o doom_u128.prg
