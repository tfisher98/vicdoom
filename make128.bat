cl65 --verbose -I c:\retro\cc65-2.13.3\include -I src -I src\textures -I . --lib-path c:\retro\cc65-2.13.3\lib -t c128 -C doom_c128_cc65.cfg -Or src\vicdoom.c src\menu.c src\automap.c src\p_enemy.c src\summary.c src\victory.c src\util.c src\cheatsAsm.s src\utilAsm.s src\enemy.s src\m_random.s src\doomlogo.s src\drawLine.s src\updateInput.s src\doomfont.s src\textures\textures.s src\dpsounds.s src\playSound.s src\drawColumnAsm.s src\logMathAsm.s src\mapAsm.s -vm -m map.txt -o doom_u128.prg
