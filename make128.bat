cl65 -I c:\retro\cc65-2.13.3\include -I src -I src\textures -I . --lib-path c:\retro\cc65-2.13.3\lib -t c128 -C doom_c128_cc65.cfg -O src\vicdoom.c src\menu.c src\automap.c src\p_enemy.c src\summary.c src\victory.c src\util.c src\cheatsAsm.s src\utilAsm_c128.s src\enemy.s src\m_random.s src\doomlogo.s src\drawLine.s src\updateInput.s src\doomfont.s src\textures\textures.s src\dpsounds.s src\playSound.s src\drawColumnAsm.s src\logMathAsm.s src\mapAsm.s -vm -m map.txt -o doom_u128.prg
...
mid2vic\debug\prepend_load_address sluts 1000
mid2vic\debug\prepend_load_address lowcode 1240
...
@echo on
c1541 -format doom,id d64 doom128.d64 -write doom_u128.prg -write ptextures -write pe1m1 -write pe1m2 -write pe1m3 -write pe1m4 -write pe1m5 -write pe1m6 -write pe1m7 -write pe1m8 -write pe1m9 -write pe1m1mus -write pe1m2mus -write pe1m3mus -write pe1m4mus -write pe1m5mus -write pe1m6mus -write pe1m7mus -write pe1m8mus -write pe1m9mus -write pintermus -write pvictormus -write psluts -write psounds -write plowcode -write phicode -write pstackcode -write phelp.txt -write pvictory1.txt -write pvictory2.txt -write pcredits.txt -write porder.txt
