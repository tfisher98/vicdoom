...
.import addysp
.importzp sp
.importzp x0,y0,x1,y1,dx,dy,sx,sy,ndxp1,err,addr,chk,drewAPixel
...
.export automap_drawSector
.export drawPlayer
.export drawLine
.export offsetAndScaleVerts
.export offsetAndScaleVert0
.export offsetAndScaleVert1
...
.proc offsetAndScaleVerts: near
  jsr offsetAndScaleVert0
  jmp offsetAndScaleVert1
.endproc

.proc automap_drawSector: near
  sta sectorIndex
  jsr _getNumVerts
  sta numVerts
  lda #0
